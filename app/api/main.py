...
# Include routers
from app.api.routes import api_keys, audit, backfill, crawl_runs, drift_signals, export, graph, images, intelligence, logs, mapping_presets, mine, operations, pages, public_v1, records, review, search, source_mapper, source_mappings, source_profiler, sources, stats, usage  # noqa: E402
...
app.include_router(source_mappings.router, prefix="/api")
app.include_router(drift_signals.router, prefix="/api")
app.include_router(drift_signals.overview_router, prefix="/api")
app.include_router(source_profiler.router, prefix="/api")
app.include_router(mapping_presets.router, prefix="/api")
app.include_router(mapping_presets.template_router, prefix="/api")
app.include_router(mapping_presets.preset_export_router, prefix="/api")
