...
def downgrade() -> None:
    op.drop_index("ix_extraction_baselines_source_updated", table_name="extraction_baselines")
    op.drop_index("ix_extraction_baselines_source_mapping", table_name="extraction_baselines")
    op.drop_table("extraction_baselines")

    op.drop_index("ix_mapping_drift_signals_source_page_field", table_name="mapping_drift_signals")
    op.drop_constraint(None, "mapping_drift_signals", type_="foreignkey")
    op.drop_constraint(None, "mapping_drift_signals", type_="foreignkey")
    op.drop_column("mapping_drift_signals", "current_value")
    op.drop_column("mapping_drift_signals", "previous_value")
    op.drop_column("mapping_drift_signals", "confidence")
    op.drop_column("mapping_drift_signals", "drift_type")
    op.drop_column("mapping_drift_signals", "field_name")
    op.drop_column("mapping_drift_signals", "record_id")
    op.drop_column("mapping_drift_signals", "page_id")
