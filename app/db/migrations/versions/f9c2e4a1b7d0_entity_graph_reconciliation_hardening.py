...
def downgrade() -> None:
    with op.batch_alter_table("entity_relationships") as batch_op:
        if _has_unique_constraint("entity_relationships", "uq_entity_relationships_entity_unique"):
            batch_op.drop_constraint("uq_entity_relationships_entity_unique", type_="unique")
        batch_op.create_unique_constraint(
    ...
    with op.batch_alter_table("entities") as batch_op:
        ...
        if _has_foreign_key_constraint("entities", "fk_entities_merged_into_entity"):
            batch_op.drop_constraint("fk_entities_merged_into_entity", type_="foreignkey")
