...
def downgrade() -> None:
    with op.batch_alter_table("entity_relationships") as batch_op:
        ...
        batch_op.drop_index("ix_entity_relationships_to_entity_id")
        batch_op.drop_index("ix_entity_relationships_from_entity_id")
    ...
    op.drop_index("ix_entity_links_source_id", table_name="entity_links")
    op.drop_index("ix_entity_links_entity_id", table_name="entity_links")
    op.drop_table("entity_links")

    op.drop_index("ix_entities_source_id", table_name="entities")
