...
def downgrade() -> None:
    ...
    op.drop_index("ix_api_usage_events_endpoint", table_name="api_usage_events")
    op.drop_index("ix_api_usage_events_tenant_id", table_name="api_usage_events")
    ...
    op.drop_index("ix_images_tenant_id", table_name="images")
    ...
    op.drop_column("records", "tenant_id")
