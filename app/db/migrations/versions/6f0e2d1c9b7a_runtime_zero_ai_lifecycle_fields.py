...
def downgrade() -> None:
    op.drop_constraint("fk_pages_mapping_version_id_used", "pages", type_="foreignkey")
    op.drop_column("pages", "mapping_version_id_used")
    op.drop_column("pages", "review_status")
    op.drop_column("pages", "review_reason")
    op.drop_column("pages", "extraction_method")
    op.drop_column("pages", "classification_method")
    op.drop_column("pages", "template_hash")
    op.drop_column("pages", "content_hash")

    op.drop_constraint("fk_sources_published_mapping_version_id", "sources", type_="foreignkey")
    op.drop_column("sources", "last_mapping_published_at")
    op.drop_column("sources", "last_discovery_run_at")
    op.drop_column("sources", "mapping_stale")
    op.drop_column("sources", "runtime_ai_enabled")
    op.drop_column("sources", "runtime_mode")
    op.drop_column("sources", "published_mapping_version_id")
