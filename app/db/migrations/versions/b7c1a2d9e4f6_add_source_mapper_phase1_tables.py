...
def downgrade() -> None:
    op.drop_table("source_mapping_sample_results")
    op.drop_table("source_mapping_sample_runs")
    op.drop_index("ix_source_mapping_rows_page_type_destination", table_name="source_mapping_rows")
    op.drop_index("ix_source_mapping_rows_mapping_version_destination_entity", table_name="source_mapping_rows")
    op.drop_index("ix_source_mapping_rows_mapping_version_status", table_name="source_mapping_rows")
    op.drop_index("ix_source_mapping_rows_mapping_version_id", table_name="source_mapping_rows")
    op.drop_table("source_mapping_rows")
    op.drop_index("ix_source_mapping_samples_page_type_id", table_name="source_mapping_samples")
    op.drop_index("ix_source_mapping_samples_mapping_version_id", table_name="source_mapping_samples")
    op.drop_table("source_mapping_samples")
    op.drop_index("ix_source_mapping_page_types_version_id", table_name="source_mapping_page_types")
    op.drop_table("source_mapping_page_types")
    op.drop_constraint("fk_sources_active_mapping_version_id", "sources", type_="foreignkey")
    op.drop_column("sources", "last_mapping_error")
    op.drop_column("sources", "last_mapping_scan_at")
    op.drop_column("sources", "mapping_status")
    op.drop_column("sources", "active_mapping_version_id")
    op.drop_index("ix_source_mapping_versions_source_status", table_name="source_mapping_versions")
    op.drop_index("ix_source_mapping_versions_source_id", table_name="source_mapping_versions")
