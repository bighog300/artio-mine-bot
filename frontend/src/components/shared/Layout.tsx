...
export function Layout({ children }: LayoutProps) {
  ...
  useEffect(() => {
    const titleByPath = [
      ...
      { path: /^\/smart-mine$/, title: "Smart Mining" },
      { path: /^\/smart-mine\/[^/]+\/progress$/, title: "Smart Mining Progress" },
      ...
      { path: /^\/entities\/merge$/, title: "Entity Merge Candidates" },
      { path: /^\/entities\/compare\/[^/]+\/[^/]+$/, title: "Entity Compare" },
      { path: /^\/entities\/[^/]+\/conflicts$/, title: "Entity Conflict Resolution" },
      { path: /^\/entities\/[^/]+$/, title: "Entity Details" },
